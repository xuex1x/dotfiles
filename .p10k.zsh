# Generated by Powerlevel10k configuration wizard on 2025-07-24 at 11:17 CST.
...
if (( P9K_SSH )); then
  ...
  POWERLEVEL9K_BACKGROUND=232
  POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_BACKGROUND=232
else
